# Remote Heart Rate detection using the Web camera and OpenCV
...
# File stream (optional, not tested)
# cap = cv2.VideoCapture("C:\\Users\\DMITRII\\Downloads\\videoplayback.mp4")
